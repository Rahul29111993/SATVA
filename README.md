...
- Install and configure [Docker](https://docs.docker.com/engine/install/).
- Clone the [repository](https://github.com/Call-for-Code/Solution-Starter-Kit-Cooperation-2020).
-  [Build the Frontend code on local](#short-description)
- [Build the Backend code on local](#2-backend-build).
[Copy the built codes to Docker directory](#3-copy-code-to-docker-directory).
[Deploy the Web App on IBM Cloud Kubernetes Cluster](#4-deploy-the-app).
